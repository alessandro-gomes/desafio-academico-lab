...
public class StaticList<E> implements List<E> {
    ...
    public int contaElementos(E el) throws IllegalArgumentException {
        ...
        return contaElementosRecursivo(el,0,0);
    }
    
    private int contaElementosRecursivo(E el, int i, int quantElementos) {
        if (i >= numElements()) return quantElementos;
        if (el.equals(elements[i])) quantElementos++;
        
        return contaElementosRecursivo(el, i+1, quantElementos);
    }
